                    ...
                    Else
                        ...
                        Select Case UCase(Command)
                            ...
                            Case "SETLIST"
                                Dim RetourSet As Boolean = False
                                Dim ValueTemp As ZWValueID = Nothing
                                Dim TextValue As String = Param(0)
                                Dim ParaAdr2 = Split(MyDevice.adresse2, ":")
                                NodeTemp = GetNode(m_homeId, MyDevice.Adresse1)
                                ValueTemp = GetValeur(NodeTemp, Trim(ParaAdr2(0)), Trim(ParaAdr2(1)))
                                If ValueTemp.GetType() = 4 Then        ' Uniquement Type list
                                    RetourSet = m_manager.SetValueListSelection(ValueTemp, TextValue)
                                    If RetourSet Then
                                        WriteLog("INFO: " & " ExecuteCommand" & "Parametre " & Param(0) & " modifié avec succès sur le noeud " & NodeTemp.ID)
                                    Else
                            ...
                            Case "SETVALEUR"
                                ...
                                NodeTemp = GetNode(m_homeId, MyDevice.Adresse1)
                                ValueTemp = GetValeur(NodeTemp, Trim(ParaAdr2(0)), Trim(ParaAdr2(1)))
                                If (ValueTemp.GetType() = 1 Or ValueTemp.GetType() = 2 Or ValueTemp.GetType() = 3 Or ValueTemp.GetType() = 6) Then        ' Uniquement Type Numérique
            ...
            Try
                ...
                Else
                    ...
                    If NodeTemp.CommandClass.Contains(CommandClass.COMMAND_CLASS_SWITCH_MULTILEVEL) Or
                        ...
                        NodeTemp.CommandClass.Contains(CommandClass.COMMAND_CLASS_THERMOSTAT_SETPOINT) Or
                    ...
                    ElseIf (Objet.Type = "TEMPERATURECONSIGNE" Or Objet.Type = "GENERIQUEVALUE") Then ' Or Objet.Type = "TEMPERATURE") Then
                        ...
                        Select Case UCase(Commande)
                            ...
                            Case "SETVALEUR"     'Ecrire une valeur vers le device physique Wake Up Interval
                                If Not (IsNothing(Parametre1)) Then
                                    Dim ValDimmer As Integer = Parametre1    'Integer   Single
                                    ...
                                    If IsMultiLevel Then
                                        ...
                                        Else
                                            ...
                                            Dim Tep = CByte(ValDimmer)
                                            m_manager.SetValue(ValueTemp, Tep)
...
#Region "Fonctions internes"
        ...
        Private Sub traiteValeur(ByVal m_notification As ZWNotification) ', Optional ByVal FromEvent As Boolean = False)
            ...
            Try
                ...
                Dim TEMP(20) As String   'a vérifier si 20 est suffisant ?
