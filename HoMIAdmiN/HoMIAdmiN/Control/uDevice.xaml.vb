        ...
        Try
            ...
            Else 'Modification d'un Device
                ...
                If x IsNot Nothing Then 'on a trouvé le device
                    ...
                    'Afficher le Bouton du gestionnaire de chauffage
                    If _Driver.Nom = "GestionChauffage" Then   'Or _Driver.Nom = "Excel" Then
                        BtnGestion.Visibility = Windows.Visibility.Visible
                    End If
                                ...
                                Else
                                    ...
                                    If String.IsNullOrEmpty(_Driver.LabelsDevice.Item(k).Parametre) = False Then
                                        ...
                                        Else
                                            ...
                                            CbAdresse1.SelectedIndex = 0  'force la selection de la valeur
                                        End If
                                    Else
                                        CbAdresse2.Visibility = Windows.Visibility.Collapsed
                                        CbAdresse2.Tag = "Driver"
...
Private Sub BtnGestion_Click(sender As Object, e As RoutedEventArgs) Handles BtnGestion.Click
        ...
        Try
            ...
            Dim y As New uGestionChauff(_DeviceId, _Driver)
            y.Uid = System.Guid.NewGuid.ToString()
            AddHandler y.CloseMe, AddressOf UnloadControl
            Window1.CanvasUser.Children.Add(y)
        Catch ex As Exception
