...
Public Class HoMIGuI
    ...
    Private Sub ContextMenuStrip_Opening(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles homiguiContextMenuStrip.Opening
        ...
        If IsConnect Then
            ...
            SauverConfigToolStripMenuItem.Enabled = True   'Ajout JPS
            SauverConfigToolStripMenuItem.ToolTipText = "Sauver la configuration"
        Else
            ...
            SauverConfigToolStripMenuItem.Enabled = False     'Ajout JPS
            SauverConfigToolStripMenuItem.ToolTipText = "Non disponible : Non connecté en SOAP au serveur"
        End If
        getdrivers()
    ...
    Private Sub SauverConfigToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SauverConfigToolStripMenuItem.Click
        'Ajout Jps
        Try
            Dim Retour As String = ""
            If IsConnect Then
                Retour = myService.SaveConfig(_IdSrv)
                If Retour = "0" Then
                    MessageBox.Show("La configuration a été sauvée", "HoMIGuI - Sauver Config", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Else
                    MessageBox.Show(Retour, "HoMIGuI - Sauver Config", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                End If
            End If
        Catch ex As Exception
            MessageBox.Show("Sauver la Configuration" & vbCrLf & ex.ToString, "HoMIGuI - SauverConfigToolStripMenuItem", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        End Try
    End Sub
